...
class Mydonor extends StatefulWidget {
  @override
  _MydonorState createState() => _MydonorState();
}

class _MydonorState extends State<Mydonor> {
                ...
                child: Container(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Mollika Das",style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 17),
                      ),
                      SizedBox(height: 10,),
